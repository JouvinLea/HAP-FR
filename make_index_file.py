...
def make_index_file():
    observation_list = ListObservations("Crab_test.list" ,"elm_south_stereo_Prod15_5")
    #observation_list = ListObservations("runlist.list" ,"elm_south_stereo_Prod15_5")
    obs_table(observation_list, "/Users/jouvin/Desktop/these/FITS_DATA/HAP-FR/Prod15_4_stereo/elm_south_stereo_Prod15_5", "old", "obs-index.fits.gz" )
    file_table(observation_list, "/Users/jouvin/Desktop/these/FITS_DATA/HAP-FR/Prod15_4_stereo/elm_south_stereo_Prod15_5", "old", "hdu-index.fits.gz" )
